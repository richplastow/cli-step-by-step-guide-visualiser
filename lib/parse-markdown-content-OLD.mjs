...
function highlightJsChildToNode(child) {
  if (typeof child === 'string') return child; // Return plain text as-is
  const {
 ...
 *
 * @param {string} codeBlock - The unprocessed content of a markdown file, to parse.
 * @returns {object[]} - An array of nodes representing the parsed markdown file.
